...
export default function ManagerList() {
  ...
  const fetchManagers = async () => {
    try {
      const res = await axios.get("https://task-manageratlas-backend.vercel.app/api/managers");
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `https://task-manageratlas-backend.vercel.app/api/managers/${id}`
      );
   ...
   const handleResetPassword = async (id) => {
    ...
    try {
      await axios.put(`https://task-manageratlas-backend.vercel.app/api/managers/${id}/reset-password`, {
        newPassword,
      });
