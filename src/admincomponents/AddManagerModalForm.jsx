...
function AddManagerModalForm({ isOpen, onClose, onCreated }) {
  ...
  useEffect(() => {
    if (isOpen) {
      axios
        .get("https://task-manageratlas-backend.vercel.app/api/departments")
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://task-manageratlas-backend.vercel.app/api/managers", { ...form, role: "manager" });
      setForm({
        name: "",
        email: "",
        password: "",
